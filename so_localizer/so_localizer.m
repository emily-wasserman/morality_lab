...
target_image{1}=fullfile(rootdir,'so_localizer','images','participants',[subjID '.png']); % self image
target_image{2}=fullfile(rootdir,'so_localizer','images','confederates',[confed '.png']); % other image
